...
from kronos_modeller.config import config
from kronos_modeller.model import KronosModel
from kronos_modeller import PlotHandler
from kronos_modeller import PlotModelJob
from kronos_modeller import WorkloadData
...
def user_workload():
    """
    Example function that generates a simplified workload (by explicitly calling kronos-generate-test-workload)
    ...
    subprocess.Popen([os.path.join(dir_bin, 'kronos-generate-test-workload'),
