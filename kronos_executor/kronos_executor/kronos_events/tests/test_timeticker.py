...
class TimeTickerTests(unittest.TestCase):
    ...
    def test_timeticker(self):
        ...
        sec_list = ticker.get_elapsed_seconds(starttime+timedelta(seconds=2.2))
        self.assertEqual(sec_list, [0, 1, 2])
        self.assertEqual(ticker.all_times, [0, 1, 2])
        self.assertEqual(ticker.last_logged_second, 2)

        sec_list = ticker.get_elapsed_seconds(starttime+timedelta(seconds=9.1))
        ...
        sec_list = ticker.get_elapsed_seconds(starttime+timedelta(seconds=11))
        ...
        sec_list = ticker.get_elapsed_seconds(starttime+timedelta(seconds=11.9))
