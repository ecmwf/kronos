...
class ExporterTimeSeriesIOrates(ExporterBase):
    """
    This class export a plot with jobs, nodes and processes per class
    """

    class_export_type = "time_series_io_rates"
    default_export_format = "png"
    ...
    def _make_plots(self, sim, times_plot, fig_format, job_classes, output_path=None):
        ...
        # user options for the lines in the plot
        plot_lines = self.export_config["lines"]
        ...
        # Set plot limits if specified by the user..
        if plot_lines.get("kb_written"):
            if plot_lines["kb_written"].get("y_lims"):
                plt.ylim(plot_lines["kb_written"]["y_lims"])
            if plot_lines["kb_written"].get("x_lims"):
                plt.xlim(plot_lines["kb_written"]["x_lims"])
        ...
        # Set plot limits if specified by the user..
        if plot_lines.get("kb_written_sec"):
            if plot_lines["kb_written_sec"].get("y_lims"):
                plt.ylim(plot_lines["kb_written_sec"]["y_lims"])
            if plot_lines["kb_written_sec"].get("x_lims"):
                plt.xlim(plot_lines["kb_written_sec"]["x_lims"])
        ...
        # Set plot limits if specified by the user..
        if plot_lines.get("writing_processes"):
            if plot_lines["writing_processes"].get("y_lims"):
                plt.ylim(plot_lines["writing_processes"]["y_lims"])
            if plot_lines["writing_processes"].get("x_lims"):
                plt.xlim(plot_lines["writing_processes"]["x_lims"])
...
# TODO: to be re-implemented once the scattered data needed have been defined
